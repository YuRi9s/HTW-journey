 ...
 * (übung4)
 * After adding the class Linked-list we should change this constructor so that
 * we Ensure that the Harvest class implements the Comparable<Harvest> interface
 * so that harvest objects can be compared based on their attributes
 */
public abstract class Harvest implements Serializable, Comparable<Harvest> {

    private int bushels;
    private int year;
    private int durability; // New attribute for durability
    ...
    public Harvest(int durability) {
        this.durability = durability;
    }

    /**
     * Creates a new Harvest instance based on the specified grain type, amount, and
     * year.
     * This factory method centralizes the creation of Harvest objects, allowing for
     * easy creation
     * of the correct type of Harvest based on the grain type. It enhances
     * maintainability and
     * consistency across the application by providing a single point of
     * modification for creating
     * Harvest objects.
     *
     * @param type   The type of grain for the harvest, represented as a
     *               {@link Game.GrainType} enum.
     * @param amount The amount of grain harvested, which should be a positive
     *               integer.
     * @param year   The year of the harvest, which should be a positive integer
     *               representing the year.
     * @return A new instance of a subclass of Harvest that corresponds to the
     *         specified grain type.
     * @throws IllegalArgumentException If the specified grain type is not
     ...
     * This method utilizes the factory pattern to generate a new instance of the
     * same type
     * as the provided {@code other} harvest object, copying its state.
     * <p>
     * This approach ensures that all properties specific to the actual type of the
     * harvest,
     * such as grain type and amount, are preserved in the new instance, maintaining
     * the
     * integrity of the harvest data.
     *
     * @param other The {@link Harvest} object to be copied.
     * @return A new {@link Harvest} instance that is a deep copy of the
     *         {@code other} object,
     *         maintaining the same type, amount of grain, and year of harvest.
     * @throws IllegalArgumentException if the {@code other} parameter is
     *                                  {@code null} or if
     *                                  the grain type of {@code other} is not
     *                                  recognized.
     */
    ...
    /**
     * Gets the durability of the grain.
     *
     * @return The durability of the grain.
     */
     ...
     *
     * @return A string containing information about the amount and year of the
     *         harvest.
     */
     ...
     * Übung (4)
     *
     * Add compareTo() method to compare harvest objects
     */
    @Override
