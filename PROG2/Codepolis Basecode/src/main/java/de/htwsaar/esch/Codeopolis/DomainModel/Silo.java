...
public class Silo implements Serializable {
    ...
    public Silo(Silo other) {
        ...
        this.stock = Arrays.stream(other.stock)
                .map(Harvest::copy)
                .toArray(Harvest[]::new);
    }

    /**
     * Returns a copy of the current stock array.
     *
     * @return A copy of the current stock array.
     */
     ...
     *
     * @return A deep copy of the current stock array.
     */
    public Harvest[] copyStock() {
    ...
    public Harvest[] emptySilo() {
        Harvest[] removedHarvests = getStockCopy();
    ...
    public int decay(int currentYear) {
        int totalDecayedAmount = Arrays.stream(stock, 0, stockIndex + 1)
                .mapToInt(harvest -> harvest.decay(currentYear))
                .sum();
