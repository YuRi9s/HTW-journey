...
public class Main {
    public static void main(String[] args) {
        ...
        // i) f(x) = x
        apply.printline();
        apply.applyAndPrint(1, 5, (int x) -> x); // Lambda expression
        ...
        // iii) f(x) = x^(x+1)
        apply.printline();
        apply.applyAndPrint(1, 5, (int x) -> (int) Math.pow(x, x + 1)); // Lambda expression
        ...
        apply.applyAndPrint_case2(1, 10, x -> x * x, even);
